  ...
  return (
    <div>
      <button
        ...
        onClick={signIn}
        disabled={loading}
        className="flex h-11 w-full items-center justify-center gap-3 rounded-md border border-night-200 bg-white px-4 text-sm font-semibold text-night-800 transition-colors hover:bg-night-50 disabled:opacity-60"
      >
